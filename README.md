...
(This repository is a branch repository. I have fixed the issue where connections for versions 4.0.0-4.2.0 could not be accessed, replaced them with package download links, and added a Chinese translation for use by Chinese users, so there's no need to rely on Bing Translator。Stupid Bing🙄)
